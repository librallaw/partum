                                                    ...
                                                    <div class="pt-3 p-lg-5 ">
                                                        ...
                                                        <form method="post" action="" id="settingsform45a6190f7">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="form-control" name="number" onblur="resetbankform45a6190f7();" id="banknumber45a6190f7" value="" required="">
                                                                </div>
                                                        ...
                                                        <a href="javascript:void(0)" class="gx-btn gx-btn-green">
                                                            <i class="zmdi zmdi-money-box"></i>
                                                            <span>Verify Account Now</span></a>

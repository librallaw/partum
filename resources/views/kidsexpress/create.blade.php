...
<!-- END: Header -->
    ...
    <!-- END: Left Aside -->
        <div class="m-grid__item m-grid__item--fluid m-wrapper" style=" background: #FFC122;background-image: url('/images/bk33.jpg');background-size: repeat">

            <!-- BEGIN: Subheader -->
            <div class="m-subheader ">
                <div class="d-flex align-items-center">
                    <div class="mr-auto" style="background: white; padding:10px;border-radius: 40px;">
                        <h3 class="m-subheader__title " style="color:#c9315c;font-family: 'Handlee', cursive;">Create Kids Express</h3>
                    </div>
            ...
            <div class="m-content" >
                ...
                <div class="row" >
                    ...
                    <div class="col-xl-5" style=" padding-left: 15px; /* newly added styling */
   ;

}" >

                        <div class="m-portlet m-portlet--full-height  "style="background: #ffc121;color:#ea6e2f;font-family: 'Kranky', cursive;">
                            <div class="m-portlet__body" >
                                ...
                                <ul class="m-nav m-nav--hover-bg m-portlet-fit--sides">
                                    ...
                                    <li class="m-nav__item">
                                        ...
                                        <form method="post" action="{{route("DoAddKidsExpress")}}" style="padding:30px"
                                            ...
                                            <input class="form-control input-child" type="text" name="title"  />
                                            <br />
                    ...
                    <div class="col-xl-4">
                        ...
                        <div id="result_cal" style="font-weight: bold;text-align: justify">
                        ...
                        <div class="kt-portlet kt-bg-danger kt-portlet--skin-solid kt-portlet--height-fluid"
                             style="background: #ffc121 !important;color: #ffffff;">
                            ...
                            <div class="kt-portlet__body">
                                ...
                                <div class="kt-widget7 kt-widget7--skin-light">
                                    <div class="kt-widget7__desc" style="font-family: 'Butterfly Kids', cursive;
                                    font-size: 25px;font-weight: bold;color:black;">


                                        Creating a kid express savings is a great way to teach money management
                                        skills and start him or her on the way to financial success.<br /><br /> This are accounts created for the immediate needs of your kids like replacing the school shoe, bag, or day to day needs, Before the beginning of a new term , a need is catered for,
                                    </div>
                        ...
                        <!--end:: Widgets/Announcements 2-->    </div>
...
<script>
    ...
    $("#duration").change(function() {
        ...
        if(duration > 1){
            $("#result_cal").html("<div class='alert alert-info'>From our calculations if you save <strong>N"+Math.ceil(solutDay)+"" + " daily</strong>  or if you decide to save <strong>N"+Math.ceil(solutMonth)+" " +"monthly</strong> you will achieve this target in <strong>"+duration+" months</strong>  </div>");

                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="col-md-8 col-sm-6 col-xs-12 pull-right">
                            <div class="login-div centered" data-aos="fade-up" data-aos-duration="1000" style="max-width: none;">
                                <div class="head">
                                ...
                                <form action="">
                                    <div class="body">
                                        <div class="input-box">
                                            <input placeholder="Email or Username" value="{{old("name")}}" type="text" required class="{{ $errors->has('name') ? ' is-invalid' : '' }}">
                                        ...
                                        <div class="input-box">
                                            <input placeholder="Password" type="email" required class="{{ $errors->has('email') ? ' is-invalid' : '' }}">
                                        ...
                                        <div class="input-box">
                                            <input placeholder="Password" type="password" required class="{{ $errors->has('password') ? ' is-invalid' : '' }}">
                                            <span style="position: absolute"><i class="fa fa-key"></i></span>
                                        </div>
                                        ...
                                        <div class="input-box">
                                            <input placeholder="Password" type="password" required class="{{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}">
                                            <span style="position: absolute"><i class="fa fa-key"></i></span>
                                        </div>

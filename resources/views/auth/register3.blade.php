                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="col-md-7 col-sm-6 col-xs-12 pull-right">
                            <div class="login-div2 centered" data-aos="fade-up" data-aos-duration="1000" style="max-width: 400px;">
                                <div class="head">
                                    <h3 class="purple oR m0">Register</h3>
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="body">
                                        <div class="input-box">
                                            <input placeholder="First name" value="{{old("first_name")}}" name="first_name" type="text" required class="{{ $errors->has('first_name') ? ' is-invalid' : '' }}">
                                        ...
                                        <div class="input-box">
                                            <input placeholder="Last name" name="last_name" value="{{old("last_name")}}" type="text" required class="{{ $errors->has('last_name') ? ' is-invalid' : '' }}">
                                            <span style="position: absolute"><i class="fa fa-user"></i></span>
                                        ...
                                        <div class="input-box">
                                            <input placeholder="Email" value="{{old('email')}}" type="email" name="email" required class="{{ $errors->has('email') ? ' is-invalid' : '' }}">
                                        ...
                                        <div class="input-box">
                                            <input placeholder="Password" name="password" type="password" required class="{{ $errors->has('password') ? ' is-invalid' : '' }}">
                                        ...
                                        <div class="input-box">
                                            <input placeholder="Confirm Password" type="password" name="password_confirmation" required class="{{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}">
                                            <span style="position: absolute"><i class="fa fa-key"></i></span>
                                        </div>
                                        @if ($errors->has('password_confirmation'))
                                            <div align="center" class="invalid-feedback" role="alert" >
                                    ...
                                    <div class="foot">
                                        ...
                                        <button class="btn btn-gradient W100 pull-right" data-aos="zoom-in-up" data-aos-duration="800">Register</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="col-md-5 col-sm-5 col-xs-12 header-text sectionP60">
                            ...
                            <a href="/login" ><button class="btn btn-gradient" data-aos="zoom-in-up" data-aos-duration="800">Login to your account</button></a>
                        </div>

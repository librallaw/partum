...
<head>
    ...
    <title>Withdrawal | Partum  Gateway</title>
        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-subheader ">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="m-subheader__title ">Withdrawal</h3>
                    </div>
                                ...
                                <div class="m-widget27 m-portlet-fit--sides">
                                    <div class="m-widget27__pic">
                                        ...
                                        <h3 class="m-widget27__title m--font-light">
                                            ...
                                            <span>₦{{($balance != null ? number_format($balance->balance / 100) : "0")}}.00</span>
                                        </h3>
                                        ...
                                        <ul class="m-widget27__nav-items nav nav-pills nav-fill" role="tablist">
                                            ...
                                            <li class="m-widget27__nav-item nav-item">
                                                <a class="nav-link active" data-toggle="pill"
                                                   href="#m_personal_income_quater_2">Make Withdrawal</a>
                                            </li>
                                            ...
                                            <div id="m_personal_income_quater_1" class="tab-pane active">
                                                <div class="row  align-items-center">
                                                    <div class="col">
                                                        ...
                                                        <form action="{{route("processWithdrawal")}}" method="post">
                                                            @csrf

                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td width="40%" class="logo" style="text-align: left;">
                                <h1><a href="http://partumgateway.com"><img src="https://partumgateway.com/assets/images/logo.png" /> </a></h1>
                            </td>
                        ...
                        <tr>
                            <td class="bg_light email-section">
                                <div class="heading-section" style="text-align: center; padding: 0 30px;">
                                    <h2>New Contact Us message from Partum </h2>
                                    <p style="color:black">{{$details['message']}}</p>
                                </div>

                                <div align="center">
                                <div>First Name: <strong>{{$details['first_name']}}</strong></div>
                                <div>Last Name: <strong>{{$details['last_name']}}</strong></div>
                                <div>Email : <strong>{{$details['email']}}</strong></div>
                                <div>Phone: <strong>{{$details['phone']}}</strong></div>
                                </div>
